...
const zh: Record<string, string> = {
  ...
  // 登录
  'login.welcome': '欢迎回来',
  'login.subtitle': '使用以下账号继续，以发表评论',
  'login.github': '使用 GitHub 登录',
  'login.loading': '加载中…',
  'login.none': '暂未开启任何登录方式',
  'login.noneSub': '请管理员在后台「登录方式」中配置',
  'login.errFetch': '加载登录方式失败，请刷新后重试',
  'login.errFetchSub': '如果反复失败，可能是请求过于频繁，请稍后再试',
  'login.errGeneric': '登录失败，请重试',
  'login.errState': '登录校验失败（状态已过期），请重新登录',
  'login.errDenied': '你取消了授权',
  'login.errProvider': '该登录方式未启用',
  'login.errSuspended': '账号已被暂停登录',
  'login.errThirdParty': '第三方登录失败，请稍后再试',
  'login.agree': '登录即表示同意我们的',
  'login.terms': '服务条款',
  'login.privacy': '隐私协议',
  // 第三方登录回调
  'cb.processing': '正在处理登录…',
...
const en: Record<string, string> = {
  ...
  'login.subtitle': 'Continue with an account below to leave comments',
  'login.github': 'Sign in with GitHub',
  'login.loading': 'Loading…',
  'login.none': 'No sign-in method is enabled',
  'login.noneSub': 'Ask the admin to configure it under “Sign-in methods”',
  'login.errFetch': 'Failed to load sign-in methods, please refresh and try again',
  'login.errFetchSub': 'If this keeps failing you may be rate limited, please try again later',
  'login.errGeneric': 'Sign-in failed, please try again',
  'login.errState': 'Sign-in check failed (state expired). Please try again',
  'login.errDenied': 'You cancelled the authorization',
  'login.errProvider': 'This sign-in method is disabled',
  'login.errSuspended': 'This account has been suspended',
  'login.errThirdParty': 'Third-party sign-in failed, please try again later',
  'login.agree': 'By signing in you agree to our',
  'login.terms': 'Terms of Service',
  'login.privacy': 'Privacy Policy',
  'cb.processing': 'Processing sign-in…',
