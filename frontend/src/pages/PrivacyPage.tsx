      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="card p-6 sm:p-10 space-y-10">
          ...
          <section>
            ...
            <ul className={list}>
              <li><strong>注册信息：</strong>用户名、邮箱地址等账号基本信息</li>
              <li><strong>个人资料：</strong>头像、个人简介等自愿提供的信息</li>
              <li><strong>使用数据：</strong>访问时间、浏览内容、互动行为等服务使用记录</li>
              <li><strong>技术信息：</strong>IP地址、浏览器类型、设备标识符等技术数据</li>
            </ul>
            <p className={body + ' mt-2'}>
              我们仅在必要范围内收集信息，并始终遵循最小化原则。您有权选择是否提供某些信息，但这可能影响您使用部分功能的完整性。
            </p>
          </section>
          ...
          <section>
            <h2 className={section}>4. 信息共享与披露</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>5. 数据安全</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>6. 数据保留</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>7. 您的权利</h2>
            <p className={body}>
              根据相关法律法规，您享有以下权利：
            </p>
            <ul className={list}>
            ...
            <p className={body + ' mt-2'}>
              您可以通过联系我们直接行使您的权利。我们将在合理时间内响应您的请求。
            </p>
          </section>

          <section>
            <h2 className={section}>8. Cookie和类似技术</h2>
            <p className={body}>
            ...
            <p className={body + ' mt-2'}>
              大多数浏览器允许您管理Cookie设置。您可以选择是否拒绝某些Cookie，但这可能影响部分功能的正常使用。
            </p>
          </section>

          <section>
            <h2 className={section}>9. 第三方服务</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>10. 国际数据传输</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>11. 隐私政策的变更</h2>
            <p className={body}>
          ...
          <section>
            <h2 className={section}>12. 联系与反馈</h2>
            <p className={body}>
              如果您对本隐私政策有任何疑问、建议或关切，或希望行使您的权利，请通过以下方式联系我们：
            </p>
            <p className={body + ' mt-2'}>
              <strong>邮箱：</strong>privacy@qinyining.cn
            </p>
            <p className={body + ' mt-2'}>
